...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        layout.addWidget(QLabel("Bubble Browser"))
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About Bubble", self)
        about_action.setStatusTip("Find out more about Bubble")  # Hungry!
        about_action.triggered.connect(self.about)
        help_menu.addAction(about_action)

        navigate_mozarella_action = QAction(QIcon(os.path.join('images', 'lifebuoy.png')), "Bubble Homepage", self)
        navigate_mozarella_action.setStatusTip("Go to Bubble Homepage")
    ...
    def update_title(self):
        ...
        self.setWindowTitle("%s - Bubble" % title)
...
app.setOrganizationDomain("Bubble.org")
